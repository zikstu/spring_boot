...
import com.medsci.hello.spring.boot.strategy.impl.OrderHandlerTypeImpl;
...
public class OrdersServiceImpl implements OrdersService {
    ...
    public void setOrdersHandlerMap(List<OrdersHandler> ordersHandlers){
        //注入各种类型的订单处理类
        ordersHandlerMap = ordersHandlers.stream().collect(Collectors.toMap(orderHandler -> AnnotationUtils.findAnnotation(orderHandler.getClass(), OrderHandlerType.class),
                v -> v, (v1, v2) -> v1));
    }
